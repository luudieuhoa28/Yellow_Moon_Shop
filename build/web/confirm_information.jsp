<%-- 
    Document   : confirm_information
    Created on : Oct 12, 2020, 11:10:35 PM
    Author     : dell
--%>
...
<section class="contact-section">
    <div class="container">
        <br class="row">
            <br class="col-lg-6 contact-info">
        ...
        <c:set var="user" value="${sessionScope.USER}"/>
            <form class="contact-form">
                <input name="customerName" type="text" placeholder="Your name" value="${sessionScope.USER.fullName}"/>
                <input name="phone" type="text" placeholder="Your phone" value="${sessionScope.USER.phone}" required/>
                <input name="address" type="text" placeholder="Address" value="${sessionScope.USER.address}" required/>
                <button type="submit" class="site-btn" name="btnAction" value="Confirm">Confirm</button>
            </form>
